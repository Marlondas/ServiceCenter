...
<head>
    ...
    <title>Añadir Empleado - Service Center</title>
...
<body>
    ...
    <div class="page-loader">
        ...
        <div class="loader-subtitle">Cargando Formulario de Empleado...</div>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="content-header">
                <div>
                    <h1 class="page-title">Añadir Nuevo Empleado</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.empleados.index') }}">Empleados</a></li>
                        <li class="breadcrumb-item">Añadir Empleado</li>
                    </ul>
                </div>
                <div>
            ...
            <!-- Vista previa del empleado que se está creando (actualizada en tiempo real) -->
            <div class="preview-card" id="preview-card">
                <div class="preview-header">
                    <h3 class="preview-title">
                        <i class="fas fa-user-plus"></i> Vista Previa del Empleado
                    </h3>
                    <p class="preview-subtitle">Aquí podrás ver cómo quedará el empleado con los datos ingresados</p>
                ...
                <div class="preview-body">
                    <div class="preview-content">
                        ...
                        <div class="preview-item">
                            ...
                            <div class="preview-item-value" id="preview-correo">-</div>
                        </div>
                        <div class="preview-item">
                            <div class="preview-item-title">Cargo</div>
                            <div class="preview-item-value" id="preview-cargo">-</div>
                        </div>
                        <div class="preview-item">
                            <div class="preview-item-title">Comisión</div>
                            <div class="preview-item-value">
                                <span class="preview-commission" id="preview-comision">-</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Formulario de empleado con estilos modernos -->
            <div class="form-container">
                <form action="{{ route('admin.empleados.store') }}" method="POST" id="employee-form">
                    @csrf
                    ...
                    <div class="form-header">
                        ...
                        <p class="form-section-subtitle">Datos básicos para la creación de la cuenta de usuario</p>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder=" " required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <div class="form-floating">
                                <input type="email" class="form-control" id="correo" name="correo" value="{{ old('correo') }}" placeholder=" " required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="cargo" name="cargo" value="{{ old('cargo') }}" placeholder=" " required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="comision" name="comision" value="{{ old('comision', 10) }}" min="0" max="100" step="0.01" required>
                            </div>
