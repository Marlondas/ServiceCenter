    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="form-container">
                <h2 class="form-title">Información del Servicio</h2>
                
                <form action="{{ route('admin.servicios.store') }}" method="POST" id="service-form">
                    @csrf
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="precio" name="precio" value="{{ old('precio') }}" min="0" step="1000" class="form-control" required>
                            @error('precio')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="duracion_estimada" name="duracion_estimada" value="{{ old('duracion_estimada') }}" class="form-control" placeholder="Ej: 30 minutos, 1 hora">
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo_vehiculo" name="tipo_vehiculo" class="form-select" required>
                                ...
                                <option value="ambos" {{ old('tipo_vehiculo') == 'ambos' ? 'selected' : '' }}>Ambos</option>
                            </select>
                            @error('tipo_vehiculo')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        <label class="form-check">
                            <input type="checkbox" id="activo" name="activo" class="form-check-input" value="1" {{ old('activo', true) ? 'checked' : '' }}>
            ...
            <div class="preview-card" id="preview-card">
                <div class="preview-header">
                    <div class="preview-title">Vista Previa del Servicio</div>
                </div>
                <div class="preview-body">
                    <div class="preview-label">Nombre del Servicio</div>
                    <div class="preview-value" id="preview-nombre">-</div>
                    
                    <div class="preview-label">Precio</div>
                    <div class="preview-price" id="preview-precio">$0</div>
                    
                    <div class="preview-label">Descripción</div>
                    <div class="preview-value" id="preview-descripcion">-</div>
                    
                    <div class="preview-label">Duración Estimada</div>
                    <div class="preview-value" id="preview-duracion">-</div>
                    
                    <div class="preview-label">Tipo de Vehículo</div>
                    <div id="preview-tipo-vehiculo" class="preview-badge preview-badge-primary">No seleccionado</div>
                    
                    <div class="preview-label">Estado</div>
                    <div id="preview-estado" class="preview-badge preview-badge-success">Activo</div>
                </div>
            </div>
        </main>
    </div>
