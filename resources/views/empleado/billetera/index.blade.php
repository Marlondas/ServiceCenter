...
<html lang="es">
<head>
    <title>Mi Billetera - Comisiones | Car Wash Pro</title>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * {
        ...
        .table-container:hover .comisiones-table th::after {
            transform: scaleX(1);
        }
        ...
        .comisiones-table tr:hover {
            background-color: #f8fafc;
            transform: translateX(5px);
        }
        
        .comisiones-table tr:last-child td {
            border-bottom: none;
        }
        ...
        body.dark-mode .comisiones-table th {
            background-color: #2d3748;
            color: #f8fafc;
            border-bottom-color: #4a5568;
        }
        
        body.dark-mode .comisiones-table td {
            border-bottom-color: #4a5568;
        }
        
        body.dark-mode .comisiones-table tr:hover {
            background-color: #2d3748;
        }
        ...
        .amount-negative .transaction-amount {
            color: var(--danger);
        }
        ...
        body.dark-mode .vehicle-badge {
            background-color: #2d3748;
            color: #f8fafc;
        }
        
        body.dark-mode .transaction-concept {
            color: #f8fafc;
        }
        
        body.dark-mode .transaction-amount::before {
...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="nav-items">
            ...
            <a href="{{ route('empleado.billetera') }}" class="nav-item active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-stats">
            <div class="stat-card">
                ...
                <div class="stat-title">Porcentaje de comisión</div>
                <div class="stat-value">{{ $empleado->comision ?? 10 }}%</div>
                <div class="stat-description">Tu comisión por cada servicio</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-description">Monto disponible para retiro</div>
            </div>
        </div>
        ...
        @if($comisiones->count() > 0)
            ...
            <div class="view-mode" id="table-view">
                <div class="table-container">
                    <table class="comisiones-table">
                        ...
                        <tbody>
                            @foreach($comisiones as $transaccion)
                                <tr>
                                    ...
                                    <td>
                                        @if($transaccion->lavada && $transaccion->lavada->vehiculo)
                                            {{ $transaccion->lavada->vehiculo->placa }}
                                        @else
                                            --
                                        @endif
                                    </td>
            ...
            <div class="view-mode" id="card-view">
                <div class="cards-container">
                    @foreach($comisiones as $transaccion)
                        <div class="transaction-card {{ $transaccion->tipo == 'comision' ? 'amount-positive' : 'amount-negative' }}">
                            <div class="transaction-date">
                                ...
                                <span class="badge {{ $transaccion->tipo == 'comision' ? 'badge-success' : 'badge-danger' }}">
                                    <i class="fas {{ $transaccion->tipo == 'comision' ? 'fa-plus-circle' : 'fa-minus-circle' }}"></i>
                                    {{ $transaccion->tipo == 'comision' ? 'Comisión' : 'Pago' }}
                                </span>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tableRows = document.querySelectorAll('.comisiones-table tbody tr');
            ...
            // Animación para números en tarjetas de estadísticas
            const statValues = document.querySelectorAll('.stat-value');
            statValues.forEach(value => {
                let currentText = value.textContent;
                if (currentText.includes('%')) {
                    const percentValue = parseInt(currentText);
                    let counter = 0;
                    ...
                    const formattedPart = currentText.replace(/[0-9]/g, '');
                    const numValue = parseInt(numberPart);
                    let counter = 0;
                    const step = Math.max(1, Math.floor(numValue / 50));
                    ...
                    const interval = setInterval(() => {
                        ...
                        counter = Math.min(counter + step, numValue);
                        value.textContent = '$' + formatNumber(counter);
                    }, 20);
                }
            });
        });
